...
names = ['patil', 'Puneeth', 'sidharth','sudharshan', 'patil','Azizullah Karimi', 'Hasibullah Atayi', 'khushhal Qasimyar', 'Nazif Mal',
         'pacha khan khogyani', 'Ramin paikar', 'SayedAhmad Seyar sawiz', 'Venket Rao', 'wahidullah Bdri', 'yahya Maqsidi', 'Siri']
...
def AddPartyAction(request):
    if request.method == 'POST':
      ...
      db_connection = pymysql.connect(host='127.0.0.1',port = 3306,user = 'root', password = '', database = 'evoting',charset='utf8')
